		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Application to Calculate",
									"targetURL": "#ApplicationtoCalculate-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"ApplicationtoCalculate-display": {
								"semanticObject": "ApplicationtoCalculate",
								"action": "display",
								"description": "An application to calculate ",
								"title": "Application to Calculate",
								"signature": {
									"parameters": {}
								},
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=in.sijas.coding.calculator",
									"url": sap.ui.require.toUrl("in/sijas/coding/calculator")
								}
							}
						}
					}
